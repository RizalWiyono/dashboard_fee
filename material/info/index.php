...
<body style="overflow-y: hidden;">
    ...
    <main>
            ...
            <ul>
                ...
                <li>
                    <a href="../info/" class="tooltip_right" style="cursor: pointer;" title="Information">
                        <img class="logo-user logo-side-bar-active" src="../../assets/image/Info-Icon.svg"/>
                    </a>
                </li>
        ...
        <div class="main-center full-width" id="center_section">
    ...
    <script>
        $.ajax({
            ...
            success: function(data){
                ...
                $('.menu-breakpoint').click(function(){
                    $('.title-content').css("background-color", "#FFF");
                    $('.menu-breakpoint').removeClass("breakpoint-active");
                    $(this).addClass("breakpoint-active");
                    var href_link = $(this).attr("href");
                    var href      = href_link.substring(50, 1);
                    $('#'+href).css("background-color", "#FFF9D1");
                }); 

                $(document).ready(function() {
                    $('#format_csv_send_money').DataTable( {
                        sDom: 'Brtip',
                        buttons: [
                            { extend: 'csv', className: 'csvSendMoney hidden', title: 'Send Money' }
                        ],
                        "bPaginate": false,
                        "bLengthChange": false,
                        "bFilter": true,
                    ...
                    $('#format_csv_add_team').DataTable( {
                        sDom: 'Brtip',
                        buttons: [
                            { extend: 'csv', className: 'csvAddTeam hidden', title: 'Add Team' }
                        ],
                        "bPaginate": false,
                        "bLengthChange": false,
                        "bFilter": true,
